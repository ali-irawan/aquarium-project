...
public class YellowFish extends Fish {
	...
	static {
		try {
			leftRedFish = ImageIO.read(RedFish.class.getResourceAsStream("/img/fish-yellow.png"));
			rightRedFish = ImageIO.read(RedFish.class.getResourceAsStream("/img/fish-yellow-right.png"));
		} catch (IOException e) {
			System.exit(1);
		}
	}
